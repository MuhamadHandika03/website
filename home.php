...
<head>
    ...
    <title>Rental Playstation - Home</title>
...
<body>
    ...
    <section class="hero">
        <div class="overlay">
            <h1>Welcome to Rental Playstation</h1>
            <p>Try out the fun to play the game.</p>
...
<section class="featured-rooms">
    <div class="container">
        ...
        <div class="room-list">
            <?php
            $query = "SELECT * FROM room_types ORDER BY price_per_hour ASC LIMIT 3";
            ...
            <div class="room-card">
                ...
                <div class="room-info">
                    <h3><?= $row['room_type']; ?></h3>
                    <p><?= $row['description']; ?></p>
                    <p class="room-price">Price per hour: ₹<?= $row['price_per_hour']; ?></p>
